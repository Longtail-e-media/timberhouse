...
if($booking_type==1) {
    $resbking10 .='
<form method="GET" action="result.php" class="check__availblty" target="_blank">
    <input type="hidden" name="hotel_code" value="'. $booking_code .'">
    <div class="row justify-content-center">
        <!-- Form Group -->
        <div class="form__group field">
            <input type="text" class="form__field" placeholder="Checkin" id="checkin">
            <label for="name" class="form__label">Check In</label>
        </div>
        <div class="form__group field">
            <input type="text" class="form__field" placeholder="Checkout" id="checkout">
            <label for="name" class="form__label">Check Out</label>
        </div>
        <div class="form-group width-25 mt-3">
            <a href="'.BASE_URL.'result.php?hotel_code='.$booking_code.'" class="book_now_btn">
                <button type="submit" class="theme-btn check_avaialbility">Check availability</button></a>
        </div>
    </div>
</form>
    ';
...
$jVars['module:rojai-booking']= $resbking10;
// Fastbooking
if($booking_type==3) {
    $day = date("d");
    $resbking.='
